...
class Permit extends Model
{
    ...
    protected $fillable = [
        ...
        'company_id', 'created_by', 'updated_by', 'deleted_by', 'cancel_reason', 'reference_number', 'request_type', 'happiness', 'event_id', 'term', 'paid', 'paid_event_fee', 'work_location_ar', 'lock_user_id', 'exempt_by', 'exempt_payment', 'approved_by', 'approved_date', 'rivision_number', 'permit_reference_id'
    ];
    protected $dates = ['created_at', 'issued_date', 'expired_date', 'lock', 'approved_date'];
