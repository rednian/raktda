...
class EventTruck extends Model
{
   ...
   protected $fillable = ['company_name_en', 'company_name_ar', 'plate_number', 'food_type', 'registration_issued_date', 'registration_expired_date', 'event_id', 'status', 'created_by', 'paid' ];
