                            ...
                            <div class="kt-notification kt-margin-t-10 kt-margin-b-10 kt-scroll" data-scroll="true"
                                ...
                                <a href="#" class="kt-notification__item">
                                    ...
                                    <div class="kt-notification__item-details">
                                        <div class="kt-notification__item-title">New Artist Permit is applied </div>
                                        <div class="kt-notification__item-time"> 2 min ago </div>
                                    </div>
                                </a>
                            </div>
                        </div>
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
            ...
            <div
                ...
                <div class="kt-notification">
                    <a href="{{ URL::signedRoute('company.edit', ['company'=>Auth::user()->company->company_id]) }}" class="kt-notification__item">
                        <div class="kt-notification__item-icon"> <i class="flaticon2-calendar-3 kt-font-success"></i>
                        </div>
                        <div class="kt-notification__item-details">
                            <div class="kt-notification__item-title kt-font-bold"> Account Setting </div>
