...
<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
        ...
        <ul class="kt-menu__nav ">
            ...
            <li class="kt-menu__item {{ Request::is('classification*') ? 'kt-menu__item--active': '' }}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
            ...
            <li class="kt-menu__item  kt-menu__item--submenu {{ Request::is('inspection*') ? 'kt-menu__item--active': '' }}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
            ...
            <li class="kt-menu__item  kt-menu__item--submenu {{ Request::is('permit*') ? 'kt-menu__item--open': '' }}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                    <i class="kt-menu__link-icon flaticon-tabs"></i>
                    <span class="kt-menu__link-text">Permits</span>
...
{{-- 
                            <li class="kt-menu__item  kt-menu__item--submenu {{ Request::is('settings/appovers*') ? 'kt-menu__item--open': '' }}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                                ...
                                <div class="kt-menu__submenu ">
                                    <span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item {{ Request::is('settings/approvers/create') ? 'kt-menu__item--active': '' }}" aria-haspopup="true">
                                            <a href="{{ route('approvers.create') }}" class="kt-menu__link ">
                                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                                                    <span></span>
                                                </i>
                                        ...
                                        <li class="kt-menu__item {{ Request::is('settings/approvers/create') ? 'kt-menu__item--active': '' }}" aria-haspopup="true">
                                            <a href="{{ route('approvers.index') }}" class="kt-menu__link ">
                                                <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                                                    <span></span>
                                                </i>
