    ...
    <div class="kt-header__topbar">
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--langs">
            <div id="lang" class="kt-header__topbar-wrapper" data-offset="10px,0px">
                <<<<<<< HEAD <span class="kt-header__topbar-icon {{ Auth::user()->LanguageId == 1 ? 'd-none' : '' }}  "
                    data-lang="en">
            ...
            <div class="kt-header__topbar-item kt-header__topbar-item--user">
                <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                    <div class="kt-header__topbar-user">
                        ...
                        <<<<<<< HEAD $name=ucwords(Auth::user()->NameEn);
                ...
                <div
                    ...
                    <div class="kt-user-card kt-user-card--skin-light kt-notification-item-padding-x">
                        ...
                        <div class="kt-user-card__badge"> <span
                                class="btn btn-label-success btn-sm btn-bold btn-font-md">1
