...
<!--end::Global Theme Styles -->
  ...
  @else
    <link href="{{ asset('/assets/css/demo1/skins/header/base/light.rtl.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('/assets/css/demo1/skins/header/menu/light.rtl.min.css') }}" rel="stylesheet" type="text/css" />
...
<script src="{{ asset('assets/vendors/custom/jquery-datatables-checkboxes/dataTables.checkboxes.min.js') }}"></script>
