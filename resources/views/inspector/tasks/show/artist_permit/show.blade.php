        ...
        ?>
            ...
            function artistTable() {
               artist = $('table#artist-table').DataTable({
                  ...
                  ajax: {
                     url: '{{ route('tasks.artist_permit.applicationdetails.datatable', $permit->permit_id) }}'
                  },
                  columnDefs: [
                  ...
                  columns: [
                     {data: 'person_code'},
                     {
                        render: function (type, data, full, meta) {
                           var url = '{{ url('inspector/tasks/artist_permit/artist') }}/' + full.artist_id;
                  ...
                  createdRow: function (row, data, index) {
                     ...
                     $(row).click(function () {
                        var url = '{{ url('inspector/tasks/artist_permit') }}/' + data.permit_id + '/application/' + data.artist_permit_id;
