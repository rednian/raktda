	...
	<section class="kt-portlet  kt-portlet--head-sm kt-portlet--responsive-mobile">
		<div class="kt-portlet__head kt-portlet__head--sm kt-portlet__head--noborder">
			 <div class="kt-portlet__head-label">
					<h3 class="kt-portlet__head-title kt-font-transform-u kt-font-dark">{{ __('Add New Custom Schedule') }}</h3>
			 </div>
		...
		<div class="kt-portlet__body kt-padding-t-0">
			<form method="POST" id="formAddScheduleType" action="{{ route('user_management.schedule.store', $user->user_id) }}">
			@csrf
			...
			<section class="row kt-margin-t-10">
                <div class="col-sm-6">
                    <div class="form-group form-group-sm">
                        ...
                        <input value="" type="text" name="emp_custom_name" required class="form-control form-control-sm">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group form-group-sm">
                        ...
                        <input value="" type="text" name="emp_custom_name_ar" required class="form-control form-control-sm">
                    </div>
                </div>
            </section>
