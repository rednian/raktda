	...
	<section class="kt-portlet  kt-portlet--head-sm kt-portlet--responsive-mobile">
		<div class="kt-portlet__head kt-portlet__head--sm kt-portlet__head--noborder">
			 <div class="kt-portlet__head-label">
					<h3 class="kt-portlet__head-title kt-font-transform-u kt-font-dark">{{ __('Add Holiday') }}</h3>
			 </div>
		...
		<div class="kt-portlet__body kt-padding-t-0">
			<form method="POST" id="formAddHoliday" action="{{ route('user_management.holiday.save') }}">
			@csrf
			...
			<section class="row kt-margin-t-50">
                ...
                <div class="col-sm-6">
                    <div class="form-group form-group-sm">
                        ...
                        <input type="text" class="form-control form-control-sm" name="holiday_name_ar">
                    </div>
                </div>
			</section>
