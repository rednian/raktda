...
<section class="kt-portlet kt-portlet--head-sm">
    <div class="kt-portlet__head kt-portlet__head--sm">
        <div class="kt-portlet__head-label">
            <h3 class="kt-portlet__head-title kt-font-transform-u"><span class="text-dark">Artist profile</span></h3>
        </div>
    ...
    <div class="kt-portlet__body" style="padding-bottom: 0 !important;">
        <div class="accordion accordion-solid accordion-toggle-plus kt-margin-b-5" id="accordion-personal">
            <div class="card">
                <div class="card-header" id="heading-personal">
                    <div class="card-title collapsed kt-padding-t-15 kt-padding-b-10" data-toggle="collapse"
                        data-target="#collapse-personal" aria-expanded="false" aria-controls="collapse-personal">
                        <h6 class="kt-font-dark kt-font-transform-u">{{ __('PERSONAL INFORMATION') }}</h6>
                    </div>
                </div>
                <div id="collapse-personal" class="collapse show" aria-labelledby="heading-personal"
                    data-parent="#accordion-personal" style="">
                    <div class="card-body">
                                ...
                                <div class="kt-widget__content">
                                    <div class="kt-widget__head">
                                        <div class="kt-widget__user">
                                            <span
                                                class="kt-widget__username kt-padding-b-10 kt-margin-r-5">{{ ucwords($artist_permit->fullname) }}</span>
                                            <span
                                                class="kt-switch kt-switch--outline kt-switch--icon kt-switch--success">
                                                <label>
                                                    <input
                                                        {{ $artist_permit->artist->artist_status == 'active'? 'checked': null }}
                                                        id="artist-status" type="checkbox" name="">
                                                    <span></span>
                                                </label>
                                            </span>
                                        </div>
            ...
            <div class="col-6">
                <div class="accordion accordion-solid accordion-toggle-plus " id="accordion-address">
                    <div class="card">
                        <div class="card-header" id="heading-personal">
                            <div class="card-title collapsed kt-padding-t-15 kt-padding-b-10" data-toggle="collapse"
                                data-target="#collapse-address" aria-expanded="false" aria-controls="collapse-address">
                        ...
                        <div id="collapse-address" class="collapse show" aria-labelledby="heading-address"
                            data-parent="#accordion-address" style="">
                            <div class="card-body" style="padding: 1px 1.25rem;">
                                <table class="table table-borderless table-sm">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>: <span
                                                    class="kt-font-bold ">{{ ucwords($artist_permit->address_en) }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>{{ __('Area') }}</td>
                                            <td>: <span
                                                    class="kt-font-bold">{{ ucwords($artist_permit->area->area_en) }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>{{ __('Emirate') }}</td>
                                            <td>: <span
                                                    class="kt-font-bold">{{ ucwords($artist_permit->emirate->name_en)}}</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
        ...
        <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-danger" role="tablist">
            <li class="nav-item">
                <a class="nav-link active kt-font-transform-u" data-toggle="tab" href="#kt_tabs_6_1" role="tab"
                    aria-selected="true">{{ __('PERMIT HISTORY') }}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link kt-font-transform-u" data-toggle="tab" href="#kt_tabs_6_2" role="tab"
