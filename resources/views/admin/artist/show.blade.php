      ...
      <div class="col-md-4 kt-padding">
        <div class="kt-widget kt-widget--user-profile-4 border">
          ...
          <div class="kt-widget__body kt-padding-l-5 kt-padding-r-5">
            ...
            <span>{{ __('Passport No.') }} :
              {{$artistpermit->passport_number ? $artistpermit->passport_number : '-' }}</span><br>
            ...
            <div class="kt-widget__item">
              ...
              <div class="kt-widget__details">
                ...
                <span class="kt-widget__value">
                  @if ($artistpermits = $artist->artistPermit()->whereHas('permit', function($q){
                  $q->where('permit_status', 'active'); })->get())
            ...
            <div class="kt-widget__item">
              ...
              <div class="kt-widget__details">
                ...
                <span class="kt-widget__value">
                  ...
                  <small>{{ucfirst(Auth::user()->LanguageId == 1 ? $permit->owner->company->name_en : $permit->owner->company->name_ar)}}
                  </small>
                  @endforeach
                </span>
                @endif
          ...
          <div class="card border">
            ...
            <div id="collapseOne6" class="collapse show" aria-labelledby="headingOne6" data-parent="#accordionExample6"
              ...
              <div class="card-body kt-padding-b-0">
                <form action="{{ route('admin.artist.update_status',$artist->artist_id) }}" method="post" class="form"
                  id="frm-status">
                  @csrf
                  <div class="form-group row form-group-sm">
                    ...
                    <div class="col-md-6">
                      ...
                      <textarea required="" name="remarks_ar" dir="rtl" maxlength="255"
                  ...
                  <div class="form-group row">
                    <div class="col">
                      @if ($artist->artist_status == 'active')
                      <button type="submit" class="btn btn-sm btn-maroon kt-transform-u" name="status"
        ...
        <section class="row">
          <div class="col-md-12">
            <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-danger" role="tablist">
              <li class="nav-item ">
                <a class="nav-link active kt-font-transform-u" data-toggle="tab" href="#kt_tabs_6_2" role="tab"
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="kt_tabs_6_3" role="tabpanel">
                <table class="table table-striped table-borderless table-hover border table-hover table-sm"
                  id="status-history">
                  <thead>
                    <tr>
                      <th>{{ __('NAME') }}</th>
