													 ...
													 <section class="row">
															<div class="col kt-margin-t-20 kt-margin-b-20">
																 <div class="form-group">
																		<textarea maxlength="255" name="comment" id="" rows="3" placeholder="Remarks for company..."
																		...
																		<div id="document-table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
																			 <div class="row">
																					<div class="col-sm-12 col-md-6">
																						 <div class="dataTables_length" id="document-table_length">
																								<label>
																									 <select name="document-table_length" aria-controls="document-table"
																					...
																					<div class="col-sm-12 col-md-6">
																						 <div id="document-table_filter" class="dataTables_filter">
																								<label>
																									 <input type="search" class="form-control form-control-sm" placeholder="Search..." aria-controls="document-table">
																								</label>
																						 </div>
																					</div>
																			 </div>
