	...
	<section class="kt-portlet  kt-portlet--head-sm kt-portlet--responsive-mobile">
		<div class="kt-portlet__head kt-portlet__head--sm kt-portlet__head--noborder">
			 <div class="kt-portlet__head-label">
					<h3 class="kt-portlet__head-title kt-font-transform-u kt-font-dark">Edit Profession</h3>
			 </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group form-group-sm">
                        <label class="kt-checkbox kt-checkbox--default kt-font-dark">
							<input {{ $profession->is_multiple ? 'checked' : '' }} name="is_multiple" value="1" type="checkbox"> Allows multiple permit
							<span></span>
						</label>
                    </div>
                </div>
