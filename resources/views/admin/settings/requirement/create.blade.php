		...
		<div class="kt-portlet__body kt-padding-t-0">
			...
			<section class="row kt-margin-t-50">
                <div class="col-sm-6">
					<span class="kt-switch kt-switch--outline kt-switch--sm kt-switch--icon kt-switch--success">
						<label>
							<input type="checkbox" value="1" checked="checked" name="status"> <b class="kt-padding-t-5 kt-padding-l-5 kt-font-dark" style="font-weight:normal;display:inline-block;">Enable Requirement</b>
							<span></span>
						</label>
					</span>
				</div>
            ...
            <section class="row kt-margin-t-10">
                <div class="col-sm-6">
					<span class="kt-switch kt-switch--outline kt-switch--sm kt-switch--icon kt-switch--success">
						<label>
							<input type="checkbox" name="dates_required" value="1"> <b class="kt-padding-t-5 kt-padding-l-5 kt-font-dark" style="font-weight:normal;display:inline-block;">Requires Date Validation</b>
							<span></span>
						</label>
					</span>
				</div>
