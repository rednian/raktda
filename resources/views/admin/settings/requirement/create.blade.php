...
@section('content')
	<section class="kt-portlet  kt-portlet--head-sm kt-portlet--responsive-mobile">
		...
		<div class="kt-portlet__body kt-padding-t-0">
			<form method="POST" id="formAddRequirement" action="{{ route('requirements.store') }}">
			@csrf
			<section class="row kt-margin-t-50">
                <div class="col-sm-6">
					<span class="kt-switch kt-switch--outline kt-switch--sm kt-switch--icon kt-switch--success">
						<label>
							<input type="checkbox" value="1" checked="checked" name="status"> <b class="kt-padding-t-5 kt-padding-l-5 kt-font-dark" style="font-weight:normal;display:inline-block;">{{ __('Enable Requirement') }}</b>
							<span></span>
						</label>
					</span>
				</div>
			...
			<section class="row kt-margin-t-10">
                <div class="col-sm-6">
                    <div class="form-group form-group-sm">
                        ...
                        <input value="" type="text" name="requirement_name" required class="form-control form-control-sm">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group form-group-sm">
                        ...
                        <input value="" type="text" name="requirement_name_ar" required class="form-control form-control-sm">
                    </div>
                </div>
            </section>
            <section class="row">
                <div class="col-sm-12">
                    <div class="form-group form-group-sm">
                        ...
                        <textarea rows="4" name="requirement_description" required class="form-control from-control-sm"></textarea>
                    </div>
                </div>
            </section>
            ...
            <section class="row kt-margin-t-10">
                <div class="col-sm-6">
					<span class="kt-switch kt-switch--outline kt-switch--sm kt-switch--icon kt-switch--success">
						<label>
							<input type="checkbox" name="dates_required" value="1"> <b class="kt-padding-t-5 kt-padding-l-5 kt-font-dark" style="font-weight:normal;display:inline-block;">{{ __('Requires Date Validation') }}</b>
							<span></span>
						</label>
					</span>
				</div>
            ...
            <section class="row kt-margin-t-10 validity-input kt-hide">
                <div class="col-sm-6">
                    <div class="form-group form-group-sm">
                        <label for="example-search-input" class="kt-font-dark"> {{ __('Valid before expiry date (Months)') }}
                            <span class="text-danger">*</span>
                        </label>
                        <input value="" type="text" name="validity" class="form-control form-control-sm">
                    </div>
                </div>
            </section>
                ...
                <div class="col-sm-6">
                    <div class="form-group form-group-sm">
                        ...
                        <select name="term" id="" class="form-control form-control-sm custom-select custom-select-sm">
                        	<option value=""></option>
                        	<option value="long">{{ __('Long Term') }}</option>
                        	<option value="short">{{ __('Short Term') }}</option>
                        </select>
                    </div>
                </div>
            </section>
