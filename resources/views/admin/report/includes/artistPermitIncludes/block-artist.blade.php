<section class="form-row">
    <div class="col-8">
        <section class="form-row">
                ...
                <div class="input-group input-group-sm">
                    <div class="kt-input-icon kt-input-icon--right">
                        <input type="text" class="form-control form-control-sm" aria-label="Text input with checkbox"
                               placeholder="APPLIED DATE" id="archive-applied-date">
            ...
            <div class="col-3">
                <select name="" id="archive-request-type"
                        class="form-control-sm form-control custom-select custom-select-sm "
                        onchange="ArtistPermit.new.table.draw()">
            ...
            <div class="col-3">
                <select name="" id="archive-permit-status"
                        ...
                        onchange="ArtistPermit.archive.table.draw()">
