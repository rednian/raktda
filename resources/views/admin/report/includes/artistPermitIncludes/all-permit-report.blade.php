            ...
            <section class="form-row">
                <div class="col-8">
                    <form class="form-row">
                        ...
                        <div class="col-3">
                            <select name="report-all-permit--request-type" id="all-permit-request-type" class="form-control-sm form-control custom-select custom-select-sm " onchange="processingPermit.draw()" >
                        ...
                        <div class="col-3">
                            <select  name="report-all-permit-request-status" id="all-permit-request-status" class=" form-control form-control-sm custom-select-sm custom-select" onchange="processingPermit.draw()">
                        ...
                        <div class="col-2">
                            <button type="button" class="btn btn-sm btn-secondary" id="all-permit-btn-reset">{{ __('RESET') }}</button>
                        </div>
                    </form>
                </div>
                <div class="col-md-3">
                    <div class="form-group form-group-sm">
                        <div class="kt-input-icon kt-input-icon--right">
                            <input type="search" class="form-control form-control-sm" placeholder="{{ __('Search') }}..." id="search-all-permit-request">
                            <span class="kt-input-icon__icon kt-input-icon__icon--right">
