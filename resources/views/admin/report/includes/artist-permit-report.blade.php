<div class="kt-portlet__body" style="margin-top: -40px">
    <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-danger" role="tablist"
        ...
        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#active-permit"
                                style="font-size: 11px">{{ __('ACTIVE PERMIT REPORTS') }}</a></li>
        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#pending-request"
                                data-target="#pending-request"
                                style="font-size: 11px">{{ __('PENDING REQUEST PERMITS REPORT') }}</a></li>
        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#processing-permit"
                                style="font-size: 11px">{{ __('PROCESSING PERMITS REPORT') }}</a></li>
        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#archive-permit"
                                style="font-size: 11px">{{ __('ARCHIVE PERMIT REPORT') }}</a></li>
        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#active-artist"
                                style="font-size: 11px">{{ __('ARTIST LIST') }}</a></li>
