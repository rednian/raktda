   ...
   */
                ...
                buttons: ['pageLength',
                    {
                        extend: 'pdf',
                        title: function () {
                            return 'EVENTS SEARCHED BY APPLICATION TYPE';
                        },
                        exportOptions: {
                            columns: [0, 1, 3, 5, 7, 8]
                        },
            ...
            activePermit = $('table#artist-permit-approved').DataTable({
                ...
                buttons: ['pageLength',

                    {
                        ...
                        title: function () {
                            return 'ACTIVE ARTISTS PERMIT REPORT';
                        },
                        exportOptions: {
                            columns: ':not(:last-child)',
                        },
            ...
            processingPermit = $('table#artist-permit-processing').DataTable({
                ...
                buttons: ['pageLength',

                    {
                        ...
                        title: function () {
                            return 'ARTIST PERMIT PRECESSING REPORT';
                        },
                        exportOptions: {
                            columns: ':not(:last-child)',
                        },
            ...
            archivePermit = $('table#artist-permit-rejected').DataTable({
                ...
                buttons: ['pageLength',

                    {
                        ...
                        title: function () {
                            return 'ARTIST PERMIT REJECTED REPORT';
                        },
                        exportOptions: {
                            columns: ':not(:last-child)',
                        },
        ...
        $('.artist_transaction_tab').click(function () {
            ...
            var table = $('#artist-transaction-table').DataTable({
                ...
                "columnDefs": [
                    {
                        "targets": [2,7,8,9,10,11,12,13,14,15],
                        "visible": false,
                        "searchable": false
                    },],
                processing: true,
