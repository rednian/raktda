...
<table class="table  table-hover  table-borderless table-striped border" id="block-artist">
    ...
    <tr id="filterTableCollapse" style="display: none">
        <th>
            <div class="col-sm" style="display: inline-flex;width:200px">
                ...
                <div class="modal-body">
                    <div class="container" id="tableToPrint_{{$artists->artist_id}}" style="margin-top: 10px">
                        ...
                        <table class="table table-borderless table-hover" id="artistTableHide_{{$artists->artist_id}}"
                            ...
                            <tr>
                                <th colspan="12"
                                    style="background-color:#f0f0f0;color:black;padding: 11px;text-align: center;box-shadow:4px 9px 3px -9px #000000a1">
                                    Personal Details
                        ...
                        <table class="table  table-hover table-borderless table-striped "
                            ...
                            <tr>
                                <th colspan="7"
                                    style="font-size:11px;padding: 9px;background-color: #f0f0f0;font-weight:bold;color: black;text-align: center;box-shadow: 0px 8px 10px -12px black;width: 100%">
                                    Permit
                ...
                buttons: ['pageLength',
                    {
                        ...
                        title: function () {
                            return '<img style="width:99%" src={{asset('img/raktdalogo.png')}}>' +
                                '<h1 style="font-size:21px;text-align:center">Artists With Active Permits</h1>'
                ...
                buttons: ['pageLength',
                    {
                        ...
                        title: function () {
                            if (filter_search == 1) {
                                return '<img style="width:99%" src="{{asset('img/raktdalogo.png')}}">' +
                                    '<h5 style="font-size:21px;text-align:center">Artists List Searched By Status</h5>';
                            }
                            if (filter_search == 3) {
                                return '<img style="width:99%" src="{{asset('img/raktdalogo.png')}}">' +
                                    '<h5 style="font-size:21px;text-align:center">Artists List Searched By Name</h5>';
                            }
                            if (filter_search == 4) {
                                return '<img style="width:99%" src="{{asset('img/raktdalogo.png')}}">' +
                                    '<h5 style="font-size:21px;text-align:center">Artists With Profession</h5>';
                            }

                            if (filter_search == 5) {
                                return '<img style="width:99%" src="{{asset('img/raktdalogo.png')}}">' +
                                    '<h5 style="font-size:21px;text-align:center">Artists By Nationality</h5>';
                            }

                            if (filter_search == 6) {
                                if (search_artist == 'single') {
                                    return '<img style="width:99%" src="{{asset('img/raktdalogo.png')}}">' +
                                        '<h5 style="font-size:21px;text-align:center">Artists With Single Permit</h5>';
                                }
                                if (search_artist == 'multiple') {
                                    return '<img style="width:99%" src="{{asset('img/raktdalogo.png')}}">' +
                                        '<h5 style="font-size:21px;text-align:center">Artists With Multiple Permits</h5>';
                                }
                                if (search_artist == 'all') {
                                    return '<img style="width:99%" src="{{asset('img/raktdalogo.png')}}">' +
                                        '<h5 style="font-size:21px;text-align:center">Artists With Active Permits</h5>';
                                }
                            }
                            if (filter_search == 7) {
                                return '<img style="width:99%" src="{{asset('img/raktdalogo.png')}}">' +
                                    '<h5 style="font-size:21px;text-align:center">Artists List Searched By Visa Type</h5>';
                            }

                            if (filter_search == 8) {
                                if (search_artist == '17') {
                                    return '<img style="width:99%" src="{{asset('img/raktdalogo.png')}}">' +
                                        '<h5 style="font-size:21px;text-align:center">Artists Below Age 18</h5>';
                                }
                                if (search_artist == '18') {
                                    return '<img style="width:99%" src="{{asset('img/raktdalogo.png')}}">' +
                                        '<h5 style="font-size:21px;text-align:center">Artists Above Age 18</h5>';
                                }
                            }

                            if (filter_search == 9) {
                                return '<img style="width:99%" src="{{asset('img/raktdalogo.png')}}">' +
                                    '<h5 style="font-size:21px;text-align:center">Artists List Searched By Area</h5>';
                            }
                        },
                        exportOptions: {
                            columns: [0, 1, 2, 3, 4]
                ...
                buttons: ['pageLength',
                    {
                        ...
                        title: function () {
                            if (xyz == "all") {
                                return '<img style="width:99%" src="{{asset('img/raktdalogo.png')}}">' +
                                    '<h5 style="font-size:21px;text-align:center">ALL EVENTS REPORT</h5>';
                            }
                            if (xyz == "+30") {
                                return '<img style="width:99%" src="{{asset('img/raktdalogo.png')}}">' +
                                    '<h5 style="font-size:21px;text-align:center">EVENTS IN NEXT 30 DAYS</h5>';
                            }
                            if (xyz == "-30") {
                                return '<img style="width:99%" src="{{asset('img/raktdalogo.png')}}">' +
                                    '<h5 style="font-size:21px;text-align:center">EVENTS IN PREVIOUS 30 DAYS</h5>';
                            }
                            if (xyz == "+60") {
                                return '<img style="width:99%" src="{{asset('img/raktdalogo.png')}}">' +
                                    '<h5 style="font-size:21px;text-align:center">EVENTS IN NEXT 60 DAYS</h5>';
                            }
                            if (xyz == "active") {
                                return '<img style="width:99%" src="{{asset('img/raktdalogo.png')}}">' +
                                    '<h5 style="font-size:21px;text-align:center">ALL ACTIVE EVENTS</h5>';
                            }
                        },
                        exportOptions: {
                            columns: [0, 1, 3, 5, 7, 8]
                ...
                buttons: ['pageLength',
                    {
                        ...
                        title: function () {
                            return '<img style="width:99%" src="{{asset('img/raktdalogo.png')}}">' +
                                '<h5 style="font-size:21px;text-align:center">EVENTS SEARCHED BY APPLICATION TYPE</h5>';
                        },
                        exportOptions: {
                            columns: [0, 1, 3, 5, 7, 8]
                        },
