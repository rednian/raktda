        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content" style="    font-family: Arial;border: none;box-shadow: 1px 8px 24px -2px black;">
                <div class="modal-header" style="background-color: #f7b100;">
                    <h5 class="modal-title hover_title__{{$artists->artist_id}}" id="exampleModalLabel" style="font-weight:bold;margin-left:42%;color: white">
                        {{
...
*/
        ...
        $('#application-type').change(function () {
            $('#active_ul_list li a').removeClass('active');
            ...
            table= $('#event-report').DataTable({
                ...
                buttons: ['pageLength',
                    ...
                    },
                    {
                        ...
                        title: function () { return 'EVENTS SEARCHED BY DATE'; },
                    }
                ],
                lengthMenu: [
                    [ 10, 25, 50 /*-1*/ ],
