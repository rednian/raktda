      ...
      <div class="kt-widget__top">
        ...
        <div class="kt-widget__content">
          <div class="kt-widget__head">
              <span class="kt-widget__title">{{$user_lang == 1 ? ucfirst($company->name_en) : ucfirst($company->name_ar) }}</span>
            <div class="kt-widget__action">
              <a href="{{ URL::signedRoute('company.edit', $company->company_id) }}" class="btn btn-sm btn-upper" style="background: #edeff6">{{__('Update Details')}}</a>&nbsp;
          ...
          <div class="kt-widget__subhead">
           <span class="kt-margin-r-10"> {!!permitStatus(in_array($company->status, ['rejected', 'active', 'blocked', 'draft', 'active']) ?ucfirst($company->status):'Pending')!!}</span>
          ...
          <div class="kt-widget__info row">
            <div class="col-md-8">
              ...
              <div class="kt-widget__stats">
                ...
                <div class="kt-widget__item">
                  ...
                  <div class="kt-widget__label">
                    <span class="btn btn-label-brand btn-sm btn-bold btn-upper">{{$company->trade_license_issued_date->format('d-F-Y')}}</span>
                  </div>
                </div>
                <div class="kt-widget__item">
                  <span class="kt-widget__date kt-padding-b-5">
                  ...
                  <div class="kt-widget__label">
                    <span class="btn btn-label-danger btn-sm btn-bold btn-upper">{{$company->trade_license_expired_date->format('d-F-Y')}}</span>
                  </div>
                </div>
            ...
            <div class="col-md-4">
              <div class="border kt-padding-5">
                 ...
                 <hr>
                 <h6 class="kt-font-dark kt-font-bold kt-font-transform-u kt-margin-b-10">{{ __('Contact Person Details') }}</h6>
                 <table class="table table-borderless table-sm table-display">
                   <tbody>
                     <tr>
                    ...
                    <tr>
                       ...
                       <td>{{ $user_lang == 1 ? ucwords($company->contact->designation_en) : ucwords($company->contact->designation_ar) }}</td>
                    </tr>
                    <tr>
      ...
      <div class="kt-widget__bottom">
        ...
        <div class="kt-widget__item col-md-3">
          ...
          <div class="kt-widget__details">
            ...
            <a href="#" class="kt-widget__value kt-font-brand">{{ $company->event()->whereStatus('active')->count() }}</a>
          </div>
        </div>
        ...
        <div class="kt-widget__item col-md-3">
          ...
          <div class="kt-widget__details">
            <span class="kt-widget__title kt-font-transform-u">{{__('Active Artist Permit')}}</span>
             <a href="#" class="kt-widget__value kt-font-brand">{{$company->permit()->where('permit_status', 'active')->count()}}</a>
          </div>
        </div>

        <div class="kt-widget__item kt-hide">
          <div class="kt-widget__icon">
            <i class="flaticon-network" data-toggle="kt-tooltip" data-skin="dark" data-placement="top" title="" data-original-title="{{(__('Active Artists'))}}"></i>
          </div>
          <div class="kt-widget__details">
            <div class="kt-section__content kt-section__content--solid">
              @if ( $artists = $company->artists()->where('artist_status', 'active')->get() )
                <div class="k t-badge kt-badge__pics">
                  ...
                  @if ($index <= 6)
                    <a href="javascript:void(0)" class="kt-badge__pic" data-toggle="kt-tooltip" data-skin="brand" data-placement="top" title="" 
                    data-original-title="{{ucwords($artist->artistPermit()->latest()->first()->fullname)}}">
                      <img src="{{ asset('storage/'.$artist->artistPermit()->latest()->first()->thumbnail) }}"  class="img-thumbnail">
                    </a>
                    @else
      ...
      <section class="row">
        <div class="col-md-12">
          <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-danger" role="tablist">
              <li class="nav-item">
                <a class="nav-link active kt-font-transform-u" data-toggle="tab" href="#kt_tabs_6_1" role="tab">{{__('Documents Uploaded')}}</a>
              </li>
              <li class="nav-item">
                <a class="nav-link kt-font-transform-u" data-toggle="tab" href="#kt_tabs_6_3" role="tab">{{__('Comments')}}</a>
              </li>
            </ul>
