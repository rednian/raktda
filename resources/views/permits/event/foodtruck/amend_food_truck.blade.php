<div class="modal fade" id="amend_food_truck" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <form class="col-md-12" id="truck_details_form">
                    <div class="row">
                        <div class="col-md-4 form-group form-group-xs">
                            ...
                            <input type="text" dir="ltr" class="form-control form-control-sm" name="company_name_en"
                                id="company_name_en" autocomplete="off">
                        </div>
                        <div class="col-md-4 form-group form-group-xs">
                            <label for="" class="col-form-label kt-font-bold">{{__('Establishment Name (AR)')}}</label>
                            <input type="text" dir="rtl" class="form-control form-control-sm" name="company_name_ar"
