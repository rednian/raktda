    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{__('Edit Food Truck')}} <span
                        id="truck_num_disp"></span>
                </h5>
...
<div class="modal fade" id="foodTruckDetails" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{__('Add Food Truck')}}
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                </button>
            </div>
            <div class="modal-body">
                ...
                <div class="kt-pull-right kt-margin-t-10">
                    <button class="btn btn-sm btn--maroon" id="add_td">{{__('Add')}}</button>
                </div>
            </div>
        </div>
    </div>
